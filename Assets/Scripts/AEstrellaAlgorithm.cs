...
public class AEstrellaAlgorithm : MonoBehaviour
{
    ...
    private void StarterCoroutine()
    {
        ...
        StartCoroutine(AEstrellaCoroutine());
    }
    IEnumerator AEstrellaCoroutine()
    {
        while (_frontier.Count > 0)
        {
            ...
            foreach (var next in neighbours)
            {
                ...
                var priority = newCost + AEstrella(objective, next);
    ...
    private int AEstrella(Vector3Int first, Vector3Int second)
    {
